...
export const CardHardSkill: React.FC<CardHardSkillProps> = ({ name }) => {
    ...
    return (
        <div className="w-72 bg-[#242424] h-12 justify-between pb-3 rounded-md flex flex-row ps-6 pe-6 pt-3 cursor-pointer hover:bg-[#F41C54] group hover:text-white transition ease-in-out duration-500 delay-75">
