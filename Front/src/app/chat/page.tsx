                            ...
                            <div className="w-full h-full flex flex-row">
                                ...
                                <div className="flex flex-col h-full w-[80%]">
                                    ...
                                    <div className="flex w-full h-20 rounded-r bg-[#313131] dark:bg-slate-100 lex-row justify-center gap-4 items-center p-4">
                                        ...
                                        <button onClick={() => { handleNewMessage(); setMsg(''); }} className="rounded-[100%] h-10 w-10 min-w-10 bg-[#2B2B2B] dark:bg-[#F41C54] flex justify-center items-center hover:scale-105">
