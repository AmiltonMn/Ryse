...
public interface GroupRepository extends JpaRepository<Group, Long> {
    ...
    void updateGroup(@Param("newDescription") String newDescription, @Param("newName") String newName,
            @Param("newObjective") String newObjective, @Param("idGroup") Long idGroup);
