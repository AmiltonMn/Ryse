...
public interface QuestionRepository extends JpaRepository<Question, Long>{
    ...
    @Query(value = "Select * from tb_question WHERE id_user = :idUser", nativeQuery = true)
    List<Question> getQuestionByUser(@Param("idUser") Long idUser);

    @Query(value = "Select * from tb_question WHERE id_question = :idQuestion", nativeQuery = true)
    List<Question> getQuestion(@Param("idQuestion") Long idQuestion);
}
